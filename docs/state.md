...
| Fact | Value |
| ---- | ----- |
| rust_tests_total | 347 |
| rust_tests_gateway | 96 |
| rust_tests_protocol_core | 133 |
| rust_tests_workflow_schema | 20 |
...
- **Rust: 347 tests** (workspace, zero failures).
